...
MODELS = 'Retrieval' #Retrieval/CMN/CG/CR/CGI
...
if __name__ == "__main__":
    ...
    if DATASET_NAME == 'MIMIC':
        ...
        dataset = TextDataset(text_file=TEXT_FILE, label_file=LABEL_FILE, sources=SOURCES, targets=TARGETS,
                              vocab_file='/workspace/data/files/mimic_unigram_1000.model', max_len=1000)
        ...
        dataset = TextDataset(text_file=TEXT_FILE, label_file=LABEL_FILE, sources=SOURCES, targets=TARGETS,
                              vocab_file='/workspace/nlp-cgi/Datasets/NLMCXR/nlmcxr_unigram_1000.model', max_len=1000)
