...
from datasets import NLMCXR, MIMIC, ours
from models_baseline import Classifier, TNN
...
if __name__ == "__main__":
    ...
    # --- Choose a Dataset ---
    #mimic_dataset = MIMIC('./Datasets/MIMIC/', view_pos=['AP','PA','LATERAL'], sources=SOURCES, targets=TARGETS, vocab_file='mimic_unigram_1000.model')
    dataset = NLMCXR('./Datasets/NLMCXR/', view_pos=['AP','PA','LATERAL'], sources=SOURCES, targets=TARGETS, vocab_file='nlmcxr_unigram_1000.model')
    ...
    checkpoint_path_from = 'checkpoints/{}_{}_{}.pt'.format('NLMCXR',MODEL_NAME,COMMENT)
